...
class BoTorchDirichletClassifier(botorch.models.gp_regression.SingleTaskGP):
    ...
    def __init__(self, train_inputs, train_targets, *args, **kwargs):
        ...
        self.mean_module = gpytorch.means.ConstantMean()  # batch_shape=torch.Size((len(train_targets.unique()),)))
        self.covar_module = gpytorch.kernels.ScaleKernel(
            kernels.MultiOutputLatentKernel(
    ...
    #     return botorch.posteriors.GPyTorchPosterior(gpytorch.distributions.MultivariateNormal())
...
class BoTorchSingleTaskGP(botorch.models.gp_regression.SingleTaskGP):
    def __init__(self, train_inputs, train_targets, *args, **kwargs):
        super().__init__(train_inputs, train_targets, *args, **kwargs)
