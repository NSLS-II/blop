...
.. code-block:: python
    ...
    dofs = [
        DOF(movable=motor_x, search_domain=(-5.0, 5.0)),
        DOF(movable=motor_y, search_domain=(0.0, 10.0)),
    ]
...
.. code-block:: python
    ...
    RE(agent.learn(iterations=5, n=4))
